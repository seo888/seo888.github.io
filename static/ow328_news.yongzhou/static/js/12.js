...
links[1] = "http://life.hn0746.com/index.php?m=poster&c=index&a=poster_click&siteid=1&id=22";
if (isIE){
	if (document.readyState=="complete"){
		statAD('1', '22', '12');
	} else {
		document.onreadystatechange=function(){
			if(document.readyState=="complete") statAD('1', '22', '12');
		}
	}
} else {
	statAD('1', '22', '12');
...
imgs[1].src = "http://life.hn0746.com/uploadfile/2020/1113/20201113112828242.jpg";
var tits = new Array();
tits[1] ="";
var imgwidth = 1200;//图片宽度
var imgheight = 60;//图片宽度
var str = "";
...
function statAD(siteid, id, pid) {
	...
	sp.src = "http://life.hn0746.com/index.php?m=poster&c=index&a=show&siteid="+siteid+"&id="+id+"&spaceid="+pid;
