function ruguoPager() {
	...
	this.isShowFirstPage = "auto",
	this.isShowPreviousPage = "auto",
	this.isShowNextPage = "auto",
	this.isShowLastPage = "auto",
	this.isShowPages = "auto",
	this.isShowAll = "auto",
	this.isShowGo = "auto"
}
...
function ruguoPagerLoad(myPager) {
    ...
    } else if (isShowFirstPage == "auto" && pageCount > 1) {
        PagerString += CreateInfos(currPage, pageCount, itemCount); 
    }
...
function ShowAll(objName) {
    var alltxt = objName.contents.replaceAll("{分页:pager}", "");
