            ...
            function () {
                ...
                switch (printType) {
                    ...
                    case 'printarea':
                        ...
                        content=!content?document.getElementsByClassName("content")[0]:content;
                        var pdfCanvas = content.getElementsByTagName('canvas')[0];
                        var pdfImage = "<img class='pdfImage' src='" + pdfCanvas.toDataURL() + "' />";
                        $('.pdf-content').append(pdfImage);
                        $('.pdf-content canvas').hide();
                        $printArea.printArea({
                            mode: "popup",
                            popClose: true,
                            popWd: 1000,
                        ...
                        $('.pdf-content canvas').show();
                        $('.pdf-content .pdfImage').hide();
                        break;
                    //打印页面
                    case 'printpage':
