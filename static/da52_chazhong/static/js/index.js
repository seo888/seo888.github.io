    ...
    keepFocusInModal: function() {
        ...
        _doc.addEventListener( 'keydown', function( event ) {
            var toggleTarget, modal, selectors, elements, menuType, bottomMenu, activeEl, lastEl, firstEl, tabKey, shiftKey,
                clickedEl = damenhu.toggles.clickedEl;
...
damenhuDomReady( function() {
    damenhu.toggles.init();              // Handle toggles.
    damenhu.coverModals.init();          // Handle cover modals.
    damenhu.intrinsicRatioVideos.init(); // Retain aspect ratio of videos on window resize.
    damenhu.modalMenu.init();            // Modal Menu.
    damenhu.primaryMenu.init();          // Primary Menu.
    damenhu.touchEnabled.init();         // Add class to body if device is touch-enabled.
} );
