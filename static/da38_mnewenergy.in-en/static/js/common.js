...
document.onkeydown = function(e) {
	...
	if(k == 37) {
		try{if(Dd('MyCms_previous').value && typeof document.activeElement.name == 'undefined')Go(Dd('MyCms_previous').value);}catch(e){}
	} else if(k == 39) {
		try{if(Dd('MyCms_next').value && typeof document.activeElement.name == 'undefined')Go(Dd('MyCms_next').value);}catch(e){}
