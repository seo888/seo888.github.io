...
dwr.engine._origScriptSessionId = "12C3A942C39FD9FE2622B0BBFD68F669";
  ...
  if (batch.req) {
    ...
    if (indexSafari >= 0) {
      ...
      if (parseInt(version, 10) < 400) {
        ...
        else dwr.engine._handleWarning(batch, { name:"dwr.engine.oldSafari", message:"Safari GET support disabled. See /dwr/server/servlet and allowGetForSafariButMakeForgeryEasier." });
      }
    }
...
dwr.engine._lookup = function(referto, data, name) {
  var lookup;
  // Can't use a map: /ajax/javascript-gotchas
