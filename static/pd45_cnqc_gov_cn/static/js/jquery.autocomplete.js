...
(function (factory) {
    ...
    Autocomplete.prototype = {
        ...
        fixPosition: function () {
            ...
            if (that.options.fixContentPostion) {
                styles = that.options.fixContentPostion(styles);
            }
        ...
        adjustScroll: function (index) {
            ...
            if (that.options.onAdjustScroll) {
                that.el.val(that.options.onAdjustScroll(that.suggestions[index].value));
            } else {
