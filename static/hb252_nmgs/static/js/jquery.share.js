...
(function () {
    var a =
        ".ops_shareLayer ul,.ops_shareLayer li,.ops_shareLayer a,.ops_shareLayer i{margin:0px;padding:0px;}.ops_shareLayer{line-height:30px; position:absolute; top:6px;right:5px;}.ops_shareLayer .ops_tit{color:#8C8C8C;float:left;margin-right:5px;font-size:14px;}.ops_shareLayer .ops_icons{float:left;}.ops_shareLayer .ops_icons li{float:left;height:30px;width:30px;list-style:outside none none;margin-right:10px;}.ops_shareLayer .ops_icons a{float:left;border-radius:15px;-moz-border-radius:15px;-webkit-border-radius:15px;padding:5px;}.ops_shareLayer .ops_icons a i{background-image:url(/images/share_icons.png);height:20px;width:20px;line-height:20px;display:block;cursor:pointer;}.ops_shareLayer .ops_icons a.icon_sina{background-color:#8C8C8C;}.ops_shareLayer .ops_icons a.icon_sina:hover,.ops_shareLayer .ops_icons a.icon_sina:focus{background-color:#d9534f;}.ops_shareLayer .ops_icons a.icon_sina i{background-position:0  1px;}.ops_shareLayer .ops_icons a.icon_weixin{background-color:#8C8C8C;}.ops_shareLayer .ops_icons a.icon_weixin:hover,.ops_shareLayer .ops_icons a.icon_weixin:focus{background-color:#5cb85c;}.ops_shareLayer .ops_icons a.icon_weixin i{background-position:0 -43px;}.ops_shareLayer .ops_icons a.icon_qzone{background-color:#8C8C8C;}.ops_shareLayer .ops_icons a.icon_qzone:hover,.ops_shareLayer .ops_icons a.icon_qzone:focus{background-color:#f0ad4e;}.ops_shareLayer .ops_icons a.icon_qzone i{background-position:0 -84px;}.ops_shareLayer .ops_icons a.icon_copy{background-color:#8C8C8C;}.ops_shareLayer .ops_icons a.icon_copy:hover,.ops_shareLayer .ops_icons a.icon_copy:focus{background-color:#428bca;}.ops_shareLayer .ops_icons a.icon_copy i{background-position:0 -132px;}.weixin_popup{background:#fff none repeat scroll 0 0;border:1px solid #d8d8d8;padding:10px;position:fixed;z-index:11001;text-align:left;font-size:12px;color:#333;}.weixin_popup .weixin_popup_head{color:#000;font-weight:bold;height:16px;line-height:16px;position:relative;text-align:left;}.weixin_popup .weixin_popup_head .weixin_popup_close{color:#999;font-size:18px;height:16px;position:absolute;right:0;text-decoration:none;top:0;width:16px;}.weixin_popup .weixin_popup_main{TEXT-ALIGN: center;padding-top:10px;padding-bottom:10px;}.weixin_popup .weixin_popup_foot{color:#666;line-height:22px;text-align:left;padding-left:20px;}#weixin_qrcode{height:295px;left:333.5px;bottom:150px;width:240px;}";
    ...
    var d = function () {
        ...
        var k =
            '<div class="weixin_popup_head"><a class="weixin_popup_close" id="weixin_close" onclick="hideWeixin();return false;" href="#">×</a> </div>';
        var j = '<div class="weixin_popup_foot">打开微信客户端，点击底部的“发现”<br>使用“扫一扫”将网页分享至朋友圈。 </div>';
        var l = document.createElement("div");
