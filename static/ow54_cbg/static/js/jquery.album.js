/*
* @Author: json
* @Date:   2020-01-03 19:07:51
* @Last Modified by:   Jason
* @Last Modified time: 2020-01-05 22:46:21
*/

var albumPath = (function() {
    var re = new RegExp("jquery.album.js.*"),
...
(function($) {
    ...
    jQuery.Album = function(config) {
        this.setting = {
            // 大图片显示区域
            root: $("#J_album_image_md"),
            // 大图片
            image: $("#J_album_image"),
            // 大图片的标题
            title: $("#J_album_image_ft"),
            btnDownload: $("#J_album_download"),
            // 大图片区域的导航块
            navBlock: $("#J_album_image_nav"),
            // 查看上一张图片按钮
            btnPrev: $("#J_album_image_btn_prev"),
            // 查看下一张图片按钮
            btnNext: $("#J_album_image_btn_next"),
            // 大图片显示区域的左侧
            prevBlock: $("#J_album_image_nav_left_block"),
            // 大图片显示区域的右侧
            nextBlock: $("#J_album_image_nav_right_block"),
            // 大图片切换时的loading图片
            overlay: $("#J_album_image_loading_overlay"),
            // 图片缩略图 Carousel 对象
            Carousel: new jQuery.Carousel({
                root: '#J_album_carousel',
                carousel: '#J_album_carousel_list',
                pages: {
                    prev: '#J_album_carousel_btn_prev',
                    next: '#J_album_carousel_btn_next'
                },
                direction: 'H'
            }),
            // 当前显示图片在缩略图的中索引值
