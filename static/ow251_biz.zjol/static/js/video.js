...
ControlBar.prototype.options_ = {
  children: ['playToggle',  'currentTimeDisplay', 'timeDivider', 'durationDisplay', 'progressControl', 'liveDisplay',  'customControlSpacer', 'playbackRateMenuButton', 'chaptersButton', 'descriptionsButton', 'subtitlesButton', 'captionsButton', 'audioTrackButton', 'fullscreenToggle']
};
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    if (!options.swf) {
     ...
     // options.swf = '//vjs.zencdn.net/swf/' + ver + '/video-js.swf';
      options.swf = 'http://cdn.v.zjol.com.cn/videojs/video-js.swf';
