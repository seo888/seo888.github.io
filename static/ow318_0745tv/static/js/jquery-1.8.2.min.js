...
(function (a, b) {
    ...
    p.fn = p.prototype = {
        ...
        var a,
            ...
            j = arguments.length,
            k = !1;
        typeof h == "boolean" && (k = h, h = arguments[1] || {}, i = 2), (typeof h === "undefined" ? "undefined" : _typeof(h)) != "object" && !p.isFunction(h) && (h = {}), j === i && (h = this, --i);
        for (; i < j; i++) {
    ...
    p.Callbacks = function (a) {
        ...
        if (n.attachEvent) for (k in { submit: !0, change: !0, focusin: !0 }) {
    ...
    p.extend({
        ...
        data: function data(a, c, d, e) {
            ...
            if ((typeof c === "undefined" ? "undefined" : _typeof(c)) == "object" || typeof c == "function") e ? k[l] = p.extend(k[l], c) : k[l].data = p.extend(k[l].data, c);
    ...
    p.event = {
        ...
        trigger: function trigger(c, d, f, g) {
            if (!f || f.nodeType !== 3 && f.nodeType !== 8) {
                ...
                c = (typeof c === "undefined" ? "undefined" : _typeof(c)) == "object" ? c[p.expando] ? c : new p.Event(s, c) : new p.Event(s), c.type = s, c.isTrigger = !0, c.exclusive = i, c.namespace = t.join("."), c.namespace_re = c.namespace ? new RegExp("(^|\\.)" + t.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, m = s.indexOf(":") < 0 ? "on" + s : "";
                if (!f) {
        ...
        fixHooks: {},
        keyHooks: { props: "char charCode key keyCode".split(" "), filter: function filter(a, b) {
        ...
        bc.matches = function (a, b) {
            ...
            createPseudo: z,
            match: W,
            attrHandle: Z ? {} : { href: function href(a) {
    ...
    p.fn.extend({
        ...
        cssHooks: { opacity: { get: function get(a, b) {
                    if (b) {
        ...
        style: function style(a, c, d, e) {
            ...
            g = typeof d === "undefined" ? "undefined" : _typeof(d), g === "string" && (f = bR.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat(p.css(a, c)), g = "number");
    ...
    p.fn.extend({ serialize: function serialize() {
    ...
    cj = ct.exec(ck.toLowerCase()) || [], p.fn.load = function (a, c, d) {
        ...
        var e,
            ...
            h = this,
            i = a.indexOf(" ");
        return i >= 0 && (e = a.slice(i, a.length), a = a.slice(0, i)), p.isFunction(c) ? (d = c, c = b) : c && (typeof c === "undefined" ? "undefined" : _typeof(c)) == "object" && (f = "POST"), p.ajax({ url: a, type: f, dataType: "html", data: c, complete: function complete(a, b) {
        ...
        ajax: function ajax(a, c) {
            ...
            (typeof a === "undefined" ? "undefined" : _typeof(a)) == "object" && (c = a, a = b), c = c || {};
            var d,
                e,
                f,
                g,
    ...
    var cE = [],
        ...
        cG = /(=)\?(?=&|$)|\?\?/,
        cH = p.now();
    p.ajaxSetup({ jsonp: "callback", jsonpCallback: function jsonpCallback() {
    ...
    p.Animation = p.extend(cW, {
        ...
        var d = a && (typeof a === "undefined" ? "undefined" : _typeof(a)) == "object" ? p.extend({}, a) : { complete: c || !c && b || p.isFunction(a) && a, duration: a, easing: c && b || b && !p.isFunction(b) && b };
