...
(function () {
  var a = ".ops_shareLayer ul,.ops_shareLayer li,.ops_shareLayer a,.ops_shareLayer i{margin:0px;padding:0px;}.ops_shareLayer{line-height:44px;}.ops_shareLayer .ops_tit{display: block;padding-top: 24px;padding-bottom: 6px;font: 14px/1 Arial,Hiragino Sans GB,STHeiti,Helvetica Neue,Helvetica,Microsoft Yahei,WenQuanYi Micro Hei,sans-serif;color: #999;text-align: center;}.ops_shareLayer .ops_icons li{width:46px;height:46px;margin:10px auto 0;border:1px solid #d2d1d1;border-radius:50%;background:#fff;}.ops_shareLayer .ops_icons a{float:left;border-radius:22px;-moz-border-radius:22px;-webkit-border-radius:22px;padding:10px;}.ops_shareLayer .ops_icons a i{background-image:url(http://www.hnynet.com.cn/pc/images/ops_icons_02.png);height:25px;width:25px;line-height:24px;display:block;cursor:pointer; background-size:100% 100%;}.ops_shareLayer .ops_icons a.icon_rmwb{background-color:#ebccd1;}.ops_shareLayer .ops_icons a.icon_rmwb:hover,.ops_shareLayer .ops_icons a.icon_rmwb:focus{background-color:#cb0000;}.ops_shareLayer .ops_icons a.icon_sina i{background-image: url(https://static.ws.126.net/163/f2e/product/post2020_cms/static/images/icon_weibo.a39951d.svg);}.ops_shareLayer .ops_icons a.icon_weixin i{    background-image: url(https://static.ws.126.net/163/f2e/product/post2020_cms/static/images/icon_weixin.0eb927d.svg);}.ops_shareLayer .ops_icons a.icon_qzone i{    background-image: url(https://static.ws.126.net/163/f2e/product/post2020_cms/static/images/icon_qqzone.a2a6bdb.svg);}.ops_shareLayer .ops_icons a.icon_copy{background-color:#bce8f1;}.ops_shareLayer .ops_icons a.icon_copy:hover,.ops_shareLayer .ops_icons a.icon_copy:focus{background-color:#428bca;}.ops_shareLayer .ops_icons a.icon_copy i{background-position:0 -160px;}.weixin_popup{background:#fff none repeat scroll 0 0;border:1px solid #d8d8d8;padding:10px;position:fixed;z-index:11001;text-align:left;font-size:12px;color:#333;}.weixin_popup .weixin_popup_head{color:#000;font-weight:bold;height:16px;line-height:16px;position:relative;text-align:left;}.weixin_popup .weixin_popup_head .weixin_popup_close{color:#999;font-size:16px;height:16px;position:absolute;right:0;text-decoration:none;top:0;width:16px;}.weixin_popup .weixin_popup_main{TEXT-ALIGN: center;padding-top: 5px;padding-bottom: 5px;}.weixin_popup .weixin_popup_foot{color:#666;line-height:22px;text-align:left;text-align:center;}#weixin_qrcode{height:245px;left:50%;margin-left:-720px;top:180px;width:240px;}";
  ...
  var d = function () {
    ...
    var k = '<div class="weixin_popup_head"><a class="weixin_popup_close" id="weixin_close" onclick="hideWeixin();return false;" href="#">x</a> </div>';
    var j = '<div class="weixin_popup_foot">用微信扫码二维码分享至好友和朋友圈 </div>';
    var l = document.createElement("div");
  ...
  window._opsShare = {
    ...
    btns: [
      ...
      title: "分享到新浪微博",
      className: "icon_sina",
      url: "http://service.weibo.com/share/share.php?url=[$url]&title=[$text]&ralateUid=7308140398&source=大象网&sourceUrl=http%3a%2f%2fwww.hntv.cn%2f&content=gb2312&pic=[$pic]",
      width: 650,
      height: 500
    }, {
      title: "分享到微信",
