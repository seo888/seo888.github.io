...
;(function ($) {
    ...
    $('.page-cover').each(function(){
        $('body').html('<div class="page page-404"><div class="not-found-404"><img class="pic" src="//www.'+host+'.com/statics/mobile/images/index/404.png" alt=""><a href="https://m.'+host+'.com/" class="btn">返回首页</a></div></div>').show();
    })
})(jQuery);
