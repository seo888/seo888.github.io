...
$(function(){
    $(".nav-cont .more1").click(function(){
        $(".nav-cont .down-list").hide();
    });
    $(".nav-cont .more").click(function(){
        $(".nav-cont .down-list").show();
    });

    $(".video-cont .left-cont dd").mouseenter(function(){
        $(".video-cont .left-cont ul").hide();
        if($(this).has("ul")){
            $(this).find("ul").show();
        }
    });
...
function showBox(o = undefined){ 
	if (o==undefined) o=document.getElementById("article-ad");
        if(!o || !o.style || !o.clientHeight){
		return;
	}
	o.style.height=o.clientHeight+2+"px"; 
	if (o.clientHeight<200) setTimeout(function(){showBox(o)},5); 
} 
function closeBox(){document.getElementById("article-ad").style.display="none";}
