...
$(function(){
	$("#comment .textarea-wrap .textarea").focus(function(){
		if($(this).val() == "所有评论仅代表网友意见，人民论坛网保持中立")
		{
			$(this).val("");
		}
	}).blur(function(){
		if($(this).val() == "")
		{
			$(this).val("所有评论仅代表网友意见，人民论坛网保持中立");
		}
	});
});
...
if (o && o.clientHeight && o.clientHeight<200) setTimeout(function(){showBox(o)},5); 
} 
