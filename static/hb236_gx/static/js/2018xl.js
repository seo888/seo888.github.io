	...
	var Module = function(){
		...
		this.newsLocation = function(channelName){
			...
			var arrChannel = [{sKey:"test",sValue:"时政新闻",sUrl:"http://www.news.cn/politics/index.htm"},
								...
								{sKey:"fortune",sValue:"广西税务",sUrl:"http://www.gx.xinhuanet.com/fortune/"},
								{sKey:"gx",sValue:"广西频道",sUrl:"http://www.gx.xinhuanet.com/"}
							 ];
			var obj = {
                name: null,
                url: null,
		...
		this.fuchuang = function(){
			var fcHtml = '<div class="Xfuchaung"><iframe marginheight="0" marginwidth="0" frameborder="0" width="0" height="0" scrolling="no"  src="http://embed.xinhuanet.com/main/s?user=AllyesNetwork|TppAd|WzPc226t280&db=xinhuanet&border=0&local=yes"></iframe></div>';
			$("body").append(fcHtml);
		};
