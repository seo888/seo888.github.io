      ...
      pm_mylogo: '1,1,-100,-55',
		...
		*/
		...
		/*
			...
			4、加载滚动文字广告的函
		*/
        myweb: escape('77642b788dd887ad91b401be0e64bbf2,大众网 大众视频,http://www.dzwww.com,v1.0'),
        /*
		------------------------------------------------------------------------------------------------------------------
...
(function() {
    var CKobject = {
		...
		embedSWF: function(C, D, N, W, H, V, P) {
			...
			g = false,
            j = document,
            r = 'https://www.macromedia.com/go/getflashplayer',
            ...
            s += '<object pluginspage="https://www.macromedia.com/go/getflashplayer" ';
            s += 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ';
            s += 'codebase="https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=11,3,0,0" ';
            s += 'width="' + W + '" ';
            s += 'height="' + H + '" ';
            s += i;
            s += 'align="middle">';
 ...
 function pv(url, w, h , id){
	...
	if(extname=='m3u8')	{
	   	var flashvars={
		f:'https://www.dzwww.com/media/dzplayer/dzplayer/m3u8.swf',
	...
	CKobject.embed('https://www.dzwww.com/media/dzplayer/dzplayer/dzplayer.swf',id,'ckplayer_'+id,w,h,true,flashvars,video)	;
