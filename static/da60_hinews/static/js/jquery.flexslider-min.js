...
(function(e) {
  e.flexslider = function(t, n) {
      ...
      v = {
          ...
          controlNav: {
              ...
              setupPaging: function() {
                  ...
                  if (r.pagingCount > 1) for (var f = 0; f < r.pagingCount; f++) {
                      ...
                      r.controlNavScaffold.append("<li>" + s+'<span>'+'/'+r.pagingCount+'</span>'+ "</li>");
                      n++
                  }
          ...
          directionNav: {
              setup: function() {
                  var t = e('<ul class="' + i + 'direction-nav p_n"><li><a class="' + i + 'prev" href="#">' + r.vars.prevText + '</a></li><li><a class="' + i + 'next" href="#">' + r.vars.nextText + "</a></li></ul>");
...
})(jQuery);<!--ecms sync check [sync_thread_id="3bcee7cc5a424330844ab778a62d31c1" sync_date="2018-12-18 17:12:48" check_sum="3bcee7cc5a424330844ab778a62d31c1]-->