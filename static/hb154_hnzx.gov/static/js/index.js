$(function () {
    function rq() {
        ...
        var daytime;
        daytime = year + "年" + mon + "月" + day + "日";
        $("#timer").html(daytime + '  ' + xq);
    }
    rq();
    ...
    $('.linkItemTitle').click(function () {
        var dom = $(this).siblings('.linkList');
        dom.toggleClass('show');
        $('.linkList').not(dom).removeClass('show');
        return false;
    });
    $('body').click(function (e) {
        $('.linkList.show').toggleClass('show');
    });
